...
function(find_fftw)
    if(MSVC)
        ...
        if(FFTW_FOUND)
            ...
            message("-- Found FFTW: ${FFTW_LINK_LIBRARIES} (found version \"${FFTW_VERSION}\")")
        else()
...
function(find_flac)
    if(MSVC)
        ...
        if(FLAC_FOUND)
            ...
            message("-- Found FLAC: ${FLAC_LINK_LIBRARIES} (found version \"${FLAC_VERSION}\")")
        else()
...
function(find_glew)
    ...
    if(MSVC)
        ...
        if(GLEW_FOUND)
            ...
            message("-- Found GLEW: ${GLEW_LINK_LIBRARIES} (found version \"${GLEW_VERSION}\")")
        else()
...
function(find_ogg)
    if(MSVC)
        ...
        check_link_directory_msvc("libogg-")
        ...
        if(OGG_FOUND)
            ...
            message("-- Found Ogg: ${OGG_LINK_LIBRARIES} (found version \"${OGG_VERSION}\")")
        else()
...
function(find_opus)
    if(MSVC)
        check_include_directory_msvc("opus-" "include")
        check_link_directory_msvc("opus-" "win32/VS2015/x64")
        ...
        if(OPUS_FOUND)
            ...
            if(OPUS_CFLAGS)
                add_definitions(${OPUS_CFLAGS})
            endif()
            if(OPUS_CFLAGS_OTHER)
                add_definitions(${OPUS_CFLAGS_OTHER})
            endif()
            set(OPUS_LIBRARY ${OPUS_LIBRARIES} PARENT_SCOPE)
            message("-- Found opus: ${OPUS_LINK_LIBRARIES} (found version \"${OPUS_VERSION}\")")
        else()
...
function(find_opusfile)
    if(MSVC)
        check_include_directory_msvc("opusfile-" "include")
        check_link_directory_msvc("opusfile-" "win32/VS2015/Win32")
...
function(find_sdl)
    ...
    if(MSVC)
        check_include_directory_msvc("${DIR}L-" "lib/x86")
...
function(find_sdl2)
    ...
    if(MSVC)
        ...
        if(SDL2_FOUND)
            ...
            message("-- Found SDL2: ${SDL2_LINK_LIBRARIES} (found version \"${SDL2_VERSION}\")")
        else()
...
function(find_sndfile)
    if(MSVC)
        ...
        if(SNDFILE_FOUND)
            ...
            message("-- Found sndfile: ${SNDFILE_LINK_LIBRARIES} (found version \"${SNDFILE_VERSION}\")")
        else()
